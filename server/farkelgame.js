module.exports = class GameTurn {
    ...
    play() {
        ...
        this.previousScore = this.score || 0
        this.score += roll_results['score'];

        let nbScoring = roll_results["scoring_dice"]
        .reduce((accumulator, currentValue) => accumulator + currentValue, 0);
      /*
...
*/
        return {
            ...
            "score"                     :   this.score,
            "scoring_dices"             :   roll_results["scoring_dice"],
            "remaining_dices"           :   roll_results["non_scoring_dice"],
            "scoring_dices_number"      :   nbScoring,
            "remaining_dices_number"    :   this.nb_dices_to_roll,
            "isLosing"                  :   ((this.nb_dices_to_roll === 1 && nbScoring === 0) && (this.score === this.previousScore))?true:false,
            "isRetrivingAllDice"        :   ((this.nb_dices_to_roll === 0 )  && (this.score !== this.previousScore))?true:false,
        }
    }
